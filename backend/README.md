...
## Project Structure
    ...
    ├── testapiautostoryboa_60157  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_60157`
...
2. Clone this repo and `cd testapiautostoryboa_60157`
